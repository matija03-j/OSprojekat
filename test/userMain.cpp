...
#include "../test/Send_Recieve_test.hpp"
#include "../test/Max_Num_Threads.hpp"
#include "../test/modifikacija_Avgust.hpp"
...
void userMain() {
    ...
    switch (test) {
        ...
        case 8:
            Send_Recieve_test();
            printString("Kraj 8. testa\n");
            break;

        case 10:
            Max_Num_Of_Threads();
            printString("Kraj 9. testa\n");
            break;

        case 9:
            modifikacija_Avgust();
            printString("Kraj 10. testa\n");
            break;
